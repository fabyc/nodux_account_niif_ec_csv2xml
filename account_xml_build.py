...
if __name__ == '__main__':
    ...
    write_xml_file(account_xml, account_xml_data, 'company_charts/account_ec.xml')
    write_xml_file(tax_xml, tax_xml_data, 'company_charts/tax_ec.xml')
    #write_xml_file(account_pyme_xml, account_pyme_xml_data, 'company_charts/account_pyme.xml')

    archives = (
        'company_charts/account_ec.xml',
        'company_charts/tax_ec.xml',
